...
integer value using a pro+vided consumer. The program should include three consumers: 
...
and a consumer as parameters, and applies the modification specified by the consumer to
 the value.
...
Implement the modifyValue method such that it applies the operation specified by the 
consumer to the value.
...
Test each consumer using the modifyValue method and print the modified value after each 
operation.
