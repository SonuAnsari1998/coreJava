...
Objective:
Develop a Java application that demonstrates the use of Java Reflection and exception 
handling. The program should prompt the user to enter the fully qualified name of a class
 and attempt to dynamically load the class using Class.forName(). If the class does not 
 exist, the application must handle the resulting ClassNotFoundException gracefully.
...
-> Inside the constructor, declare a variable of type Class<?>.
   ...
   Catch ClassNotFoundException and print an appropriate message along with the stack 
   trace.
