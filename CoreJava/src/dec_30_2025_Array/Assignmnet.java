 ...
 * The system should provide courses and offers to students, allowing them to view 
 * available courses, ongoing offers, and enroll in their preferred courses.
...
Components :
-> offerText (String): Description of the special offer provided by the education 
institute.
...
Methods:
-> public void enrollStudentInCourse(int courseId, String studentName): Using this 
method student will enrolled in the course based on courseId [See the Test Case]. 
If the given courseId is not available then provide error message.
...
Return Type        : void
Access modifier    : public
In this method write the logic so, student can take admission in the course based on 
the courseId
